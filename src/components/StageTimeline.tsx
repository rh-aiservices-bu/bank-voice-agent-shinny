...
const pages: PageDef[] = [
  ...
  { id: 12, label: 'Summary', group: 'outro' },
];
        ...
        {currentPage > 0 && (
          <div
            ...
            style={{
              ...
              background: `linear-gradient(to right, #94a3b8, #fbbf24 8%, #fbbf24 20%, #22d3ee 28%, #22d3ee 70%, #34d399 75%, #34d399 90%, #94a3b8)`,
            }}
          />
        )}
